				...
				<div className="grid grid-cols-1 gap-12 lg:grid-cols-4">
					...
					<div className="lg:col-span-1">
						...
						<div className="flex space-x-4">
							<a
								href="https://github.com/xinnian999/tuchong"
								target="_blank"
								rel="noreferrer"
								aria-label="GitHub"
								className="linear-card glow micro-interaction group flex h-11 w-11 items-center justify-center transition-all duration-300 hover:bg-accent hover:text-gray-400"
							>
								<Github className="h-5 w-5 text-muted-foreground transition-transform duration-300 group-hover:scale-110" />
							</a>
						</div>
					</div>
