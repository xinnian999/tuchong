...
const navigationItems: NavItem[] = [
	...
	{
		key: "docs",
		href: "https://github.com/xinnian999/tuchong/blob/main/README_en-US.md#%EF%B8%8F-development-documentation",
		icon: ExternalLink,
		external: true,
	},
];
			...
			<div className="container mx-auto max-w-7xl">
				<div className="flex items-center justify-between">
					...
					<div className="flex items-center space-x-4">
						<img src="logo.png" alt={`${t("brand")} logo`} className="h-14 w-14" />
